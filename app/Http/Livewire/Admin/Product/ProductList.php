...
class ProductList extends Component
{
    ...
    public function render()
    {
        if ($this->storeUser == 1) {
            ...
            $productQuery = Product::with('gallery','galleries')->withSum('productQuantities', 'quantity')->withSum('productOrders', 'qty')->withSum('returnProductsQuantity', 'qty')->withSum('productReductions', 'qty')->where('quantity', '>', 0);
            ...
            $productQuery = Product2::with('gallery','galleries')->withSum('productQuantities', 'quantity')->withSum('productOrders', 'qty')->withSum('returnProductsQuantity', 'qty')->withSum('productReductions', 'qty')->where('quantity', '>', 0);
    ...
    public function save()
    {
        ...
        if ($this->product_id) {
            ...
            if ($this->storeUser == 1){
                ...
                $checkName = Product::where('id', '!=', $updateProduct->id)->where('name', $this->name)->exists();
                if($checkName){
                    $this->error_name = 'This name already added';
                    return false;
                }
                $checkBarcode = Product::where('id', '!=', $updateProduct->id)->where('bar_code', $this->bar_code)->exists();
                if($checkBarcode){
                ...
                $checkName = Product2::where('id', '!=', $updateProduct->id)->where('name', $this->name)->exists();
                if($checkName){
                    $this->error_name = 'This name already added';
                    return false;
                }
                $checkBarcode = Product2::where('id', '!=', $updateProduct->id)->where('bar_code', $this->bar_code)->exists();
                if($checkBarcode){
                    $this->error_bar_code = 'This bar code already added';
                    return false;
                }
            ...
            if ($this->storeUser == 1) {
                ...
                $checkName = Product::where('name', $this->name)->exists();
                if ($checkName) {
                    $this->error_name = 'This name already added';
                    return false;
                }
                $checkBarcode = Product::where('bar_code', $this->bar_code)->exists();
                if($checkBarcode){
                    $this->error_bar_code = 'This bar code already added';
                    return false;
                }
                ...
                $checkName = Product2::where('name', $this->name)->exists();
                if ($checkName) {
                    $this->error_name = 'This name already added';
                    return false;
                }
    ...
    public function updateProduct()
    {
        ...
        if ($this->storeUser == 1){
                ...
                $checkName = Product::where('id', '!=', $updateProduct->id)->where('name', $this->state['name'])->exists();
                if($checkName){
                    $this->error_name = 'This name already added';
                    return false;
                }
                $checkBarcode = Product::where('id', '!=', $updateProduct->id)->where('bar_code',  $this->state['bar_code'])->exists();
                if($checkBarcode){
                    $this->error_bar_code = 'This bar code already added';
                    return false;
                }
                ...
                $checkName = Product2::where('id', '!=', $updateProduct->id)->where('name',  $this->state['name'])->exists();
                if($checkName){
                    $this->error_name = 'This name already added';
                    return false;
                }
                $checkBarcode = Product2::where('id', '!=', $updateProduct->id)->where('bar_code',  $this->state['bar_code'])->exists();
                if($checkBarcode){
                    $this->error_bar_code = 'This bar code already added';
                    return false;
                }
        ...
        if ($this->storeUser == 1) {
            ...
            /*  $updateProductQuantity = $updateProduct->product_quantities_sum_quantity - ($updateProduct->product_orders_sum_qty + $updateProduct->productReductions->sum('qty')); */
