...
class ProductCart extends Component
{
    ...
    public $customer_name,$customer_phone,$customer_email, $customer_address='',$viewOrder, $card_number, $credit_points, $setting, $wallet=0, $debit_points=0, $available_points, $return=0, $return_order_id='', $return_discount, $count_cart_item, $storeUser;
    ...
    public function incrementQuantity($id, $value)
    {
        ...
        $changeProductQuantity = $product->product_quantities_sum_quantity-($product->return_products_quantity_sum_qty+$product->product_orders_sum_qty+$product->productReductions->sum('qty'));
