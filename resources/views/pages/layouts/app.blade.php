      ...
      <div class="container-fluid">
        <div class="wrapper">
          ...
          <div class="content-page">
            ...
            <!-- Cart Button -->
            @if($show != '1')
              <a href="{{route('add_to_cart')}}" class="btn btn-primary btn-lg cart-btn " role="button" title="" data-toggle="tooltip" data-original-title="cart" id="cart_home">
                  <i class="uil-shopping-cart-alt" id="h_cart">@if(isset($cartItemCount)) {{$cartItemCount}} @endif</i>
              </a>
              @endif
            <!-- Cart Button -->
