                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    @if(Auth::user()->type=='A' || in_array('sub-admin-orders-view', Auth::user()->permissions()->pluck('permission')->toArray()))
                                    <a href="{{route('sub_admin_orders.view', $user->id)}}" class="action-icon" ><i class="mdi mdi-eye"></i></a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
