                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @php
                                    ...
                                    $total_selling+=($row->subtotal-(($row->discount_type=='dis_amt'?$row->discount_amt:$row->discount_percent)+(float)$row->wallet_discount));

                                    $total_profit+=$profit;

                                    $total_discount+=($row->discount_type=='dis_amt'?$row->discount_amt:$row->discount_percent);
                                ...
                                @endphp
                                <td>{{number_format($row->subtotal-(($row->discount_type=='dis_amt'?$row->discount_amt:$row->discount_percent)+(float)$row->wallet_discount),2)}}</td>
                                ...
                                <td style="white-space: nowrap;">
                                    ...
                                    <a href="javascript:void(0);" title="View" class="action-icon" wire:click="viewOrder({{$row->id}})"><i class="mdi mdi-eye"></i></a>
                                    @endif
