			...
			<div class="card-body">
				...
				<div class="row mb-3">
					...
					<div class="col-lg-3">
						...
						<input type="text" wire:model.defer="purchase_price" class="form-control" placeholder="Purchase Price">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mt-2 mb-2">
                    ...
                    <div class="mb-3 col-md-4">
                        <label class="form-label">Purchase Price</label>
                        <input type="text" wire:model.defer="edit_purchase_price" class="form-control" placeholder="Purchase Price">
